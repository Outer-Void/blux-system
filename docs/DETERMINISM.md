...
4. Stable ordering of run graph steps by `id`.
5. Stable hashing using SHA-256 over canonical JSON payloads.
6. Deterministic timestamps when `BLUX_DETERMINISTIC_TIMESTAMP` is set.
